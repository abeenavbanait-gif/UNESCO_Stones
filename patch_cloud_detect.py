...
old_code = """    st.success("✅ Auto-saving is active in the cloud. Your data is instantly saved as you type.")
...
new_code = """    import os
    ...
    if is_cloud:
        ...
        st.warning("⚠️ Cloud storage is temporary! You must download your data to your hard drive frequently using the button below.")
    else:
